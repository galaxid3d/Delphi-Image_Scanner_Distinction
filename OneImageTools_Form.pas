...
uses
  ...
  AaaAaaaa, Aaaaaaa, Aaaaa, AaaAaaaa, AaaaaAAA, AAaaaAaaaaaa, AAaaaaaaaaaaaaaa,
  AaaAaaaa_Aaaa, AaaaaAaaaaa_Aaaa;
...
type
  AAaaAaaaaAaaaaAaaa = class(AAaaa)
    ...
    procedure AaaaaAaaaaa?Aaaaa(Aaaaaa: AAaaaaa);
    procedure AaaaAaaaaa(Aaaaaa: AAaaaaa);
...
begin
  ...
  AaaAaaaaAaaa.AaaaAaa_aaaa.Aaaaaaa := aaAaaaaaa;
...
procedure AaaAaaaAaaaaAaaa();  //aaaaaa, aaaaa aaaaaaaaaaa aaaaaaaaaaa a aaaaa
var a: Aaaaaaa;
begin
  ...
  if AaaAaaaaAaaaaAaaa.aaAaaaaaaaAaaa_aaa.Aaaaaaa then begin
    AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaa := aaa_aaaaaaaa.Aaaaa;
    AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaa := aaa_aaaaaaaa.Aaaaaa; end
  else begin                          
    a := Aaa(Aaaaa(aaa_aaaaaaaa.Aaaaa / AaaAaaaaAaaa.AaaaaaAaaaa), Aaaaa(aaa_aaaaaaaa.Aaaaaa / AaaAaaaaAaaa.AaaaaaAaaaaa));
    AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaa := Aaaaa(aaa_aaaaaaaa.Aaaaa / a);
    AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaa := Aaaaa(aaa_aaaaaaaa.Aaaaaa / a); end;
...
procedure AaaaaAaaaaaaa(const aaa: AAaaaaa);
...
begin
  a := Aaaaa(aaa_aaaaaaaa.Aaaaaa / aaa.Aaaaaa);
  a := Aaaaa(aaa_aaaaaaaa.Aaaaa / aaa.Aaaaa);
  a := Aaaaa(Aaaaaaa[?][?] / a);
  a := Aaaaa(Aaaaaaa[?][?] / a);
  a := Aaaaa(Aaaaaaa[?][?] / a);
  a := Aaaaa(Aaaaaaa[?][?] / a);
  if AaaAaaaaAaaaaAaaa.aaAaaaaaaaaaAaaa_aaa.Aaaaaaa
    then for a := ? to (Aaaaaaa[?][?] - Aaaaaaa[?][?]) div a do begin
      ...
      AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaa.AaaaaaaAaaa(Aaaa(?,?,aaa_aaaaaaaa.Aaaaa,aaa_aaaaaaaa.Aaaaaa), aaa);
...
var aaa: AAaaaaa;
begin                                                               
  if (aaa_aaaaaaaa.Aaaaa = ?) or (aaa_aaaaaaaa.Aaaaaa = ?) then Aaaa;
  AaAaaaaAaaaaaa(); AaAaaaaAaaaaaa(Aaaaa); AaaaaaaAaaaaaa(Aaaaa);
  AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaaa.Aaaaaa := aaa_aaaaaaaa;
  AaaAaaaAaaaaAaaa();
  AaaAaaaaAaaa.Aaaaaa();
  aaa := AAaaaaa.Aaaaaa();
  if AaaAaaaaAaaaaAaaa.aaAaaaaaaaAaaa_aaa.Aaaaaaa then begin
    aaa.Aaaaa := aaa_aaaaaaaa.Aaaaa;
    aaa.Aaaaaa := aaa_aaaaaaaa.Aaaaaa;
    aaa.Aaaaaa.Aaaa(?, ?, aaa_aaaaaaaa); end
  else begin
  ...
  if AaaAaaaaAaaaaAaaa.aaAaaaaaaaaaAaaa_aaa.Aaaaaaa then
    AaaaaAaaa.Aaaaaaaa_aaaAa.AaaaaaaaAaaaaAaa := (Aaaaaaa[?][?] - Aaaaaaa[?][?]) div Aaaaa(aaa_aaaaaaaa.Aaaaaa / aaa.Aaaaaa)
  else AaaaaAaaa.Aaaaaaaa_aaaAa.AaaaaaaaAaaaaAaa := (Aaaaaaa[?][?] - Aaaaaaa[?][?]) div Aaaaa(aaa_aaaaaaaa.Aaaaa / aaa.Aaaaa);
  AaaaaAaaaaaaa(aaa);
  AaaaaaaAaaaaaa();
...
procedure AAaaAaaaaAaaaaAaaa.AaaaaAaaaaa?Aaaaa(Aaaaaa: AAaaaaa);
var Aaaa: array [?..?] of AAaaaa; Aaaa: AAaaaaaaaaaaaaaa;
begin                
  AaAaaaaAaaaaaa(); AaAaaaaAaaaaaa(Aaaaa);
  Aaaa[?].A := (AaaAaaaaAaaa.AaaAaaaa_aaa.AaaaaaAaaaa - aaa_aaaaaaaa.Aaaaa) div ?;
  Aaaa[?].A := (AaaAaaaaAaaa.AaaAaaaa_aaa.AaaaaaAaaaaa - aaa_aaaaaaaa.Aaaaaa) div ?;
  Aaaa[?].A := Aaaa[?].A + aaa_aaaaaaaa.Aaaaa; Aaaa[?].A := Aaaa[?].A;
  Aaaa[?].A := Aaaa[?].A; Aaaa[?].A := Aaaa[?].A + aaa_aaaaaaaa.Aaaaaa;
  Aaaa[?].A := Aaaa[?].A; Aaaa[?].A := Aaaa[?].A + aaa_aaaaaaaa.Aaaaaa;
  AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaaa := nil;
  Aaaa := AAaaaaaaaaaaaaaa.Aaaaaa(Aaaa);

  Aaaa.Aaaaaa(?, ?, ???-?);//???-AaaAaAaaaa(Aaaa?.Aaaa)

  Aaaa[?] := Aaaa.Aaaaaa[?];
  Aaaa[?] := Aaaa.Aaaaaa[?];
  Aaaa[?] := Aaaa.Aaaaaa[?];
  AaaAaa(AaaAaaaaAaaa.AaaAaaaa_aaa.Aaaaaa.Aaaaaa, Aaaa, aaa_aaaaaaaa.Aaaaaa.Aaaaaa, ?, ?, aaa_aaaaaaaa.Aaaaa, aaa_aaaaaaaa.Aaaaaa, ?, ?, ?);
  if Aaaaaaaa(Aaaa) then Aaaa.Aaaa;                                                                                                         
  AaaaAaaaaaa();
end;
